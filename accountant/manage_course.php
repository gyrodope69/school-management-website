...
include '../config.php'; 
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM classes where class_id= ".$_GET['id']);
    ...
    <form action="" id="manage-course">
        ...
        <div class="col-lg-6 border-right">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="standard" id="standard" value="<?php echo $standard ?>" required readonly>
            </div>
            <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <table class="table table-condensed" id="fee-list">
                ...
                <tbody>
                    <?php
                        if(isset($class_id)):
                        $fees = $conn->query("SELECT * FROM fees where course_id = $class_id");
                        $total = 0;
