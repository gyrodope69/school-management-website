            ...
            if ($query == "add") {
                echo "
                   <div class='card account custom-shadow mt-5 mb-5 p-3'>
                         <h3 class='text-center'  style='background-color:gray;color:white;border-radius: 1rem 0 0 1rem;'>Add Syllabus</h3>
                        <hr>
                        <form class='card-body' style='background-color:gray;color:white;' method='POST' action='./manage-syllabus.php' enctype='multipart/form-data'>                            
